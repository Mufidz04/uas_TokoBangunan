...
// https://ateraimemo.com/Swing/RoundedDropDownList.html
import java.awt.*;
...
public final class RoundedComboBox extends JPanel {
  ...
  public static void createAndShowGui() {
    ...
    //   ex.printStackTrace();
    // }
    JFrame frame = new JFrame("RoundedDropDownList");
    frame.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
    frame.getContentPane().add(new RoundedComboBox());
    frame.pack();
